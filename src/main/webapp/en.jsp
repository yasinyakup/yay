...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#myPage"><img alt="logo" src="resources/images/logotr.png" width="35"></a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#myPage">HOME</a></li>
					<li><a href="#band">SERVICES</a></li>
					<li><a href="#tour">INTRO</a></li>
	...
	<div id="band" class="container text-center">
		<h3>SERVICES</h3>
		<p>
			<em>Translation, what we do</em>
		</p>
		<p>We have been providing translation services to the enterprises
			for 10 years. Especially in Chinese-Turkish-English, providing
			professional level translation services in oral and written by the
			experienced and certified personals.</p>
		<br>
		<div class="row">
			<div class="col-sm-4">
				<p class="text-center">
					<strong>Technical Translation</strong>
				</p>
			...
			<div class="col-sm-4">
				<p class="text-center">
					<strong>Tourism Translation</strong>
				</p>
			...
			<div class="col-sm-4">
				<p class="text-center">
					<strong>Sectoral translation</strong>
				</p>
				...
				<div id="demo3" class="collapse">
					<p>Experienced in related sector</p>
					<p>Certified&Sworn</p>
					<p>Oral and Written</p>
				</div>
			</div>
	...
	<div id="tour" class="bg-1">
		<div class="container">
			<h3 class="text-center">CHOOSE YOUR ROUTE</h3>
			<p class="text-center">Choose your own route, travel wherever,
				whenever and stay as long as you want.</p>
			<ul class="list-group">
				<li class="list-group-item">July <span
					class="label label-danger">Hot</span></li>
				<li class="list-group-item">August <span
					class="label label-danger">Hot</span></li>
			...
			<div class="row text-center">
				<div class="col-sm-4">
					<div class="thumbnail">
						...
						<p>Historical and Touristy</p>
						<button class="btn" data-toggle="modal" data-target="#myModal">Check</button>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="thumbnail">
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4>
							<span class="glyphicon glyphicon-lock"></span> Information Form
						</h4>
					</div>
					<div class="modal-body">
						<form role="form">
							<div class="form-group">
								<label for="psw"><span
									class="glyphicon glyphicon-shopping-cart"></span>How many days?</label>
							...
							<div class="form-group">
								<label for="psw"><span
									class="glyphicon glyphicon-shopping-cart"></span>How many
									person?</label> <input type="number" class="form-control" id="psw"
									placeholder="Enter person">
							</div>

							<div class="form-group">
								<label for="psw"><span
									class="glyphicon glyphicon-shopping-cart"></span>Arrive at?</label> <input
									type="date" class="form-control" id="psw" placeholder="Tarih">
							</div>
							<div class="form-group">
	...
	<div id="contact" class="container">
		...
		<p class="text-center">
			<em>Your thoughts important for us!</em>
		</p>
		...
		<div class="row">
			<div class="col-md-4">
				<p>Leave Note.</p>
				<p>
					<span class="glyphicon glyphicon-map-marker"></span>Istanbul,
					Turkey
				</p>
				<p>
			...
			<div class="col-md-8">
				...
				<textarea class="form-control" id="comments" name="comments"
					placeholder="Notes" rows="5"></textarea>
				<br>
				<div class="row">
		...
		<br>
		<h3 class="text-center">MESSAGE OF THE DAY</h3>
	...
	<img src="resources/images/maptr.jpg" class="img-responsive" style="width: 100%">
